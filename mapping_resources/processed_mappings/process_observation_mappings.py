#!/usr/bin/env python
"""Process OBSERVATION mappings to create SNOMED-mapped versions."""
...
# Output files
mapped_output = processed_dir / "OBSERVATION_snomed_mapped.csv"
reference_output = processed_dir / "OBSERVATION_mapping_reference.csv"

def load_mappings():
    """Load SNOMED mappings from observation_snomed_mappings.csv"""
    mappings = {}
...
def process_observation():
    """Process OBSERVATION file with SNOMED mappings."""
    ...
    for row in rows:
        ...
        if row['Vocab'] == 'SNOMED':
            ...
            new_row['Domain'] = 'Observation'  # Keep Observation domain
...
if __name__ == "__main__":
    print("Processing OBSERVATION mappings...")
    print("="*60)
    process_observation()
    print("="*60)
